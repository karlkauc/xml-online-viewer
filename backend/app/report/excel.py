...
_COLUMNS = [
    ...
    ("Type", 28),
    ("Domain", 18),
    ("Context (line before / error line / after)", 70),
]
...
def build_report(
    ...
    *,
    ...
    wb.properties.title = f"{APP_NAME} – Validation report"
    wb.properties.creator = APP_NAME
    wb.properties.lastModifiedBy = APP_NAME
    wb.properties.subject = f"Validation of {xml_filename} against {xsd_filename}"
    wb.properties.description = (
        f"Generated by {APP_NAME} {__version__} ({APP_URL}); author {APP_AUTHOR}."
    )
    wb.properties.keywords = "FundsXML, XSD, validation"
